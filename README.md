...
采用 CQ（恒定质量）编码模式，硬件编码器根据画面内容自动调整码率，静态画面低码率、动态画面高码率。配合 IOSurface 零拷贝管线和自适应帧率（静态 15fps / 动态 30fps），4K 录屏 CPU 占用仅 10-15%。
...
| 版本 | 下载 |
|------|------|
| v2.6.3 (高性能编码) | [NativeScreenRecorder_v2.6.3.zip](Releases/NativeScreenRecorder_v2.6.3.zip) |
